...
![成绩构成](https://img.shields.io/badge/成绩构成-gold) ![平时成绩10%](https://img.shields.io/badge/平时成绩-10%25-wheat) ![作业20%](https://img.shields.io/badge/作业-20%25-wheat) ![期末考试70%](https://img.shields.io/badge/期末考试-70%25-wheat)

2023 级，这门课与《电磁场》（2 学分）二选一[作为自动化与电气工程的分野]；2024 级，这门课与《固体力学》（3 学分）二选一[作为自动化与机器人工程的分野]。

本课程在线性代数的基础上进一步增加符合控制相关学科的代数基础内容，重点在于向量空间、线性映射等知识点。


## 教材和参考书

- Linear Algebra Done Right/Sheldon Axler-3rd ed.(2015) / 4th ed.(2023)-Springer
- Introduction to Linear Algebra/Gilbert Strang-5th ed.(2016) / 6th ed.(2023)-Wellesley-Cambridge Press
- Linear Algebra and Its Applications/Lay D.C.-5th ed.-Pearson
- Linear Algebra with Applications/Steven J. Leon--Pearson
- Linear Algebra Done Wrong/Sergei Treil--Brown University
- 控制理论中的代数基础/季海波--中国科学技术大学
- 系统与控制理论中的线性代数/黄琳--科学出版社
...
- [linear.axler.net](https://linear.axler.net/)
  ...
  > 文 / [Oliver Wu](https://github.com/OliverWu515), 2025-07-01
...
- [线性代数应该这样学 (Bilibili)](https://www.bilibili.com/video/BV1uK4y1a7jL)
  kumiko 上传的自学视频
...
> 文 / [AutoFriedRich](https://github.com/AutoFriedRich), 2024-05-01
...
> 文 / [Maxwell Jay & longlin li](https://github.com/MaxwellJay256), 2023-06-01
